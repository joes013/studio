...
export const blogPosts: BlogPost[] = [
  {
    ...
    image: blogAutomationImage ? { url: blogAutomationImage.imageUrl, alt: blogAutomationImage.description, hint: blogAutomationImage.imageHint } : null,
    content: `
  ...
  },
  {
    ...
    image: blogSustainabilityImage ? { url: blogSustainabilityImage.imageUrl, alt: blogSustainabilityImage.description, hint: blogSustainabilityImage.imageHint } : null,
    content: `
  ...
  },
  {
    ...
    image: blogCustomsImage ? { url: blogCustomsImage.imageUrl, alt: blogCustomsImage.description, hint: blogCustomsImage.imageHint } : null,
    content: `
