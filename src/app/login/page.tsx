...
export default function LoginPage() {
    ...
    const handleLogin = async (event: FormEvent) => {
        ...
        try {
            const response = await fetch(`https://sheetdb.io/api/v1/yla6vr6ie4rsn/search?usuari=${encodeURIComponent(username)}&password=${encodeURIComponent(password)}&sheet=usuari`);
